...
public class TitleBarView extends ViewGroup implements View.OnClickListener {
    ...
    public TitleBarView setImmersive(boolean immersive) {
    ...
    public TitleBarView setLeftImageResource(int resId) {
        mLeftText.setCompoundDrawablesWithIntrinsicBounds(resId, 0, 0, 0);
        return this;
    }

    public TitleBarView setLeftClickListener(OnClickListener l) {
    ...
    public TitleBarView setLeftText(int resid) {
    ...
    private TitleBarView setTitle(CharSequence title, CharSequence subTitle, int orientation) {
    ...
    public TitleBarView setCenterClickListener(OnClickListener l) {
    ...
    public TitleBarView setTitleColor(int resid) {
        mCenterText.setTextColor(resid);
        return this;
    }

    public TitleBarView setTitleSize(float size) {
        mCenterText.setTextSize(size);
        return this;
    }

    public TitleBarView setTitleBackground(int resid) {
        mCenterText.setBackgroundResource(resid);
        return this;
    }

    public TitleBarView setSubTitleColor(int resid) {

        mSubTitleText.setTextColor(resid);
        return this;
    }

    public TitleBarView setSubTitleSize(float size) {

        mSubTitleText.setTextSize(size);
        return this;
    }

    public TitleBarView setCustomTitle(View titleView) {
        if (titleView == null) {
    ...
    public TitleBarView setDivider(Drawable drawable) {
    ...
    public TitleBarView setActionTextColor(int colorResId) {
     ...
     */
    public TitleBarView setOnTitleClickListener(OnClickListener listener) {
